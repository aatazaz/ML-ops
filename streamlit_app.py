...
def process_video(video_path, model, feature_extractor, class_names):
    ...
    for prob, idx in zip(top_probs, top_indices):
        predictions.append({'class': class_names[idx.item()],
...
if __name__ == '__main__':
    ...
    best_model_path = 'best_RNN.pth'
    best_model_name = 'RNN'
    feature_dim = 2048
    class_names = ['ApplyEyeMakeup', 'ApplyLipstick', 'Archery', 'BabyCrawling', 'BalanceBeam', 'BandMarching', 'BaseballPitch', 'Basketball', 'BasketballDunk', 'BenchPress', 'Biking', 'Billiards', 'BlowDryHair', 'BlowingCandles', 'BodyWeightSquats', 'Bowling', 'BoxingPunchingBag', 'BoxingSpeedBag', 'BreastStroke', 'BrushingTeeth']

    create_streamlit_app(best_model_path, best_model_name, feature_dim, feature_extractor_app, class_names)
